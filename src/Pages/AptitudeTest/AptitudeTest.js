  ...
  const [message, setMessage] = useState([
    {
      role: "user",
      content:
        "당신은 뻔뻔해야합니다. 질문이 의도와 다르더라도 계속해서 질문해야합니다. 당신은 나에게 재미로 개발자 직군 테스트를 시작합니다. 질문은 총 10번 이루어줘야하며 코딩과는 관련 없는 단어로 이루어지며 최대한 대중적이고 재미있게 창의적으로 비전문 용어들로 20자 이상으로 이루어진 질문입니다. 대상자는 코딩과 관련 없는 사람 입니다. 대답은 예 또는 아니요 로 할 수 있는 질문이여야 합니다. 질문 한가지 해주세요. 앞으로 결과를 알려달라고 하기 전까지 질문 이외의 다른 것은 언급 하지 않습니다.이 대화를 항상 기억하세요",
    },
  ]);
    ...
    try {
      const updatedMessage = [
        ...message,
        {
          role: "user",
          content:
            "나와 했던 대화 중 처음으로 한 대화를 제외한 대화를 토대로 추천하는 개발자 직군과 이유를 알려줘.어떻게든 연관 시켜서. ",
        },
      ];
