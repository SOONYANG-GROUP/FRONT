      ...
      <>
        <div className="page-header-ui-content pt-5">
          <div className="container px-3 px-md-5">
            <div className="row gx-3 gx-md-5 align-items-center">
              <div className="col-12 col-lg-6" data-aos="fade-up">
                <h1 className="page-header-ui-title">이론보다는 실전!</h1>
                <p className="page-header-ui-text mb-4 mb-lg-5">
                  CampusCrew는 다양한 사이드프로젝트 추천과 로드맵을 함께
                  제공해드립니다.
                </p>
                <div className="d-flex flex-column flex-lg-row">
                  <a
                    className="btn btn-lg btn-soft fw-500 text-primary me-lg-3 mb-3 mb-lg-0 animate__animated animate__fadeInUp"
                    href="/projects"
                  >
                    프로젝트 확인하러가기
        ...
        <section className="bg-light py-4 py-md-5" id="explore">
          <div className="container px-3 px-md-5">
            <div className="row gx-3 gx-md-5 justify-content-center">
              <div className="col-12 col-lg-8">
                <div className="text-center mb-4 mb-lg-10">
                  <div
