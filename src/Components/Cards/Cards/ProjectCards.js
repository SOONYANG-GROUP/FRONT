        ...
        <div className="col-lg-4 mb-5 mb-lg-0 mt-3">
            <a className="card lift h-100 text-secondary shadow-sm p-3 bg-body-tertiary rounded" href="#!" style={{textDecoration: "none"}}>
                <div className="card-body">
                    ...
                    <div className="small text-gray-500">남은 시간 {project.remainingTime}일</div>
                </div>
                <div className="card-footer bg-transparent border-top d-flex align-items-center justify-content-between">
                    <div className="small text-gray-500">모집 중 {project.completedRecruitment} / {project.fields.length}</div>
